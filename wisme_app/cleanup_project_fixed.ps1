...
$filesToDelete = @(
    ...
    "lib/user/models/user_models.dart",
    ...
    "lib/providers/user_progress_provider_v2.dart",
    "lib/providers/achievement_provider_v2.dart",
    "analysis.txt",
...
# PHASE 2: Rename fixed files to their correct names
Write-Host ""
Write-Host "PHASE 2: Renaming fixed files..." -ForegroundColor Yellow
...
$filesToRename = @{
    ...
    "lib/UI/widgets/app_button_fixed.dart" = "lib/UI/widgets/app_button.dart"
}
